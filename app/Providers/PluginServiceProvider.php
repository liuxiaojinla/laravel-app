...
class PluginServiceProvider extends ServiceProvider
{
     ...
     * @return void
     */
    public function registerFactoryResolvers(): void
    {
        FactoriesFactory::guessFactoryNamesUsing(function ($modelName) {
        ...
        FactoriesFactory::guessModelNamesUsing(function (FactoriesFactory $factory) {
